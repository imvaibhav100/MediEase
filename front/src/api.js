...
export const BACKEND_BASE = ENV_BASE && ENV_BASE.trim().length > 0
  ? ENV_BASE.trim()
  : (window.location.hostname === 'localhost' ? 'http://localhost:8080' : 'https://mediease-backend-gtvp.onrender.com');
